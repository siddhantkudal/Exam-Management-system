...
public class Login_Student extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(265, 567));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/rec/icons8_student_male_70px.png"))); // NOI18N
    ...
    private void loginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginBtnActionPerformed
        ...
        try{
           ...
           //String usertypeStr = usertypeCombo.getSelectedItem().toString();
            LoginSession.Usertype="Student"; 
            
            if(operations.isLogin(usernameStr, passwordStr, this)){
                Student_Dashboard pi = new Student_Dashboard();
                pi.setVisible(true);
                this.dispose();
            }else{
...
//        close();
//        Main_Dashboard pi = new Main_Dashboard();
//        pi.setVisible(true);
